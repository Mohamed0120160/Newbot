/**
 * 🎥 YouTube Video Downloader (Final Version) — نيزوكو
...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    if (args.length === 3 && args[0] === 'getvid') {
        ...
        try {
            ...
            console.error('Nezuko Download Error:', e);
            await m.react('❌');
    ...
    try {
        ...
        console.error('Nezuko Title Fetch Error:', e);
        await m.react('❌');
