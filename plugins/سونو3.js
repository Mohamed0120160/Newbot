/**
 * 🎤 Suno AI Text-to-Song v3 — نيزوكو سونو (توليد الأغاني بالذكاء الاصطناعي)
...
const handler = async (m, { conn, text, usedPrefix, command }) => {
  try {
    ...
    // تحويل المدة لصيغة دقائق وثواني مفهومة لبوت نيزوكو
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          sourceUrl: "https://whatsapp.com/channel/0029VbCfnh30AgW5Ygh1ZZ37"
        }
      }
    }, { quoted: m });

    // 2️⃣ إرسال رسالة الكلمات المزخرفة بعناية لنيزوكو بوت
    let lyricsCaption = 
