...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    if (!text) {
        return m.reply(
            ...
            `📌 *الاستخدام:*\n` +
            `${usedPrefix + command} https://whatsapp.com/channel/XXXXXXXXX/175\n\n` +
            `📝 *ملاحظة:*\n` +
            `• انسخ الرابط من القناة مباشرة\n` +
            `• الرابط يكون بالشكل: https://whatsapp.com/channel/XXXX/YYYY`
        );
    }
    ...
    if (!urlMatch) {
        ...
        return m.reply(
            `❌ *رابط غير صالح!*\n\n` +
            `✅ *الرابط الصحيح:*\n` +
            `https://whatsapp.com/channel/XXXXXXXXX/175\n\n` +
