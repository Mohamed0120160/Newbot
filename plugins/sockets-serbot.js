// تعديل أوامر السيربوت إلى نييييزوكو و تنصيب
// BY MONTE 🌿
...
handler.help = ['نييييزوكو', 'تنصيب']
handler.tags = ['serbot']
handler.command = ['نييييزوكو', 'تنصيب']   // ← الأمران الجديدان
...
export async function yukiJadiBot(options) {
    ...
    let isCodeMode = (command === 'تنصيب') ? true : false
